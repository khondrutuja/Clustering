...
#here we are going to use transactinal data wherein size of 
#each row is not
...
#earlier groceries datastructure was in string format,now it
# will change to
...
#you will get all the itemd occured in all transactions
